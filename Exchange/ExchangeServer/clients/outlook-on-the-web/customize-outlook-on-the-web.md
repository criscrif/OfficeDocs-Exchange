...
|2|olk_logo_white.png|`%ExchangeInstallPath%FrontEnd\HttpProxy\owa\auth\<ExchangeVersion>\themes\resources`and '%ExchangeInstallPath%\V15\ClientAccess\Owa\prem\<ExchangeVersion>\resources\images\0'|128 x 108|32|
|3|owa_text_blue.png|`%ExchangeInstallPath%FrontEnd\HttpProxy\owa\auth\<ExchangeVersion>\themes\resources` and '%ExchangeInstallPath%\V15\ClientAccess\Owa\prem\<ExchangeVersion>\resources\images\0'|300 x 76|32|
